...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "d", function() os.execute("rofi -show run")
end,
              {description = "show menu", group="hotkeys"}),
    awful.key({ modkey,           }, "p", function() os.execute("rofi -show window")
end,
              {description = "show windows", group="hotkeys"}),
    -- Tag browsing
